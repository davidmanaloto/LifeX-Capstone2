  ...
  item: [
    {
      ...
      item: [
        ...
        { linkId: 'state', text: 'Region / Province', type: 'string' },
        { linkId: 'zip', text: 'Zip / Postal Code', type: 'string' },
        { linkId: 'phone', text: 'Phone', type: 'string' },
        { linkId: 'government-id', text: 'Government ID Number (optional)', type: 'string' },
        {
        ...
        { linkId: 'sexual-orientation', text: 'Sexual Orientation (optional)', type: 'string' },
      ],
    },
    {
      ...
      item: [
        ...
        { linkId: 'emergency-contact-middle-name', text: 'Middle Name', type: 'string' },
        { linkId: 'emergency-contact-last-name', text: 'Last Name', type: 'string' },
        { linkId: 'emergency-contact-phone', text: 'Phone', type: 'string' },
      ],
    },
    {
      linkId: 'allergies',
      ...
      item: [
        ...
        { linkId: 'allergy-onset', text: 'Onset', type: 'dateTime' },
      ],
    },
    {
      linkId: 'medications',
      ...
      repeats: true,
      item: [
        { linkId: 'medication-code', text: 'Medication Name', type: 'string' },
        { linkId: 'medication-note', text: 'Note', type: 'string' },
      ],
    },
    {
      ...
      repeats: true,
      item: [
        { linkId: 'medical-history-problem', text: 'Problem', type: 'string' },
        {
        ...
        { linkId: 'medical-history-onset', text: 'Onset', type: 'dateTime' },
      ],
    },
    {
      ...
      repeats: true,
      item: [
        { linkId: 'family-member-history-problem', text: 'Problem', type: 'string' },
        {
        ...
        { linkId: 'family-member-history-deceased', text: 'Deceased', type: 'boolean' },
      ],
    },
    {
      ...
      repeats: true,
      item: [
        { linkId: 'immunization-vaccine', text: 'Vaccine', type: 'string' },
        { linkId: 'immunization-date', text: 'Administration Date', type: 'dateTime' },
      ],
    },
    {
          ...
          extension: [
            {
              ...
              valueCodeableConcept: {
                coding: [{ system: 'http://hl7.org/fhir/fhir-types', display: 'Organizations', code: 'Organization' }],
              },
            },
          ],
        },
    ...
    },
    {
      ...
      item: [
        ...
        { linkId: 'subscriber-id', text: 'Subscriber ID', type: 'string', required: true },
        {
          ...
          enableWhen: [
            {
              ...
              operator: '!=',
              answerCoding: { system: 'http://terminology.hl7.org/CodeSystem/subscriber-relationship', code: 'other', display: 'Other' },
            },
            {
              question: 'relationship-to-subscriber',
              operator: '!=',
              answerCoding: { system: 'http://terminology.hl7.org/CodeSystem/subscriber-relationship', code: 'self', display: 'Self' },
            },
            {
              question: 'relationship-to-subscriber',
              operator: '!=',
              answerCoding: { system: 'http://terminology.hl7.org/CodeSystem/subscriber-relationship', code: 'injured', display: 'Injured Party' },
            },
          ],
          item: [
    ...
    },
    {
      ...
      item: [
        ...
        { linkId: 'veteran-status', text: 'Veteran Status', type: 'boolean' },
        {
          linkId: 'pregnancy-status',
          text: 'Pregnancy Status',
          type: 'choice',
          code: [{ code: '82810-3', display: 'Pregnancy status', system: 'http://loinc.org' }],
          answerOption: [
            ...
            { valueCoding: { system: 'http://snomed.info/sct', code: '102874004', display: 'Possible pregnancy' } },
            { valueCoding: { system: 'http://terminology.hl7.org/CodeSystem/v3-NullFlavor', code: 'UNK', display: 'Unknown' } },
          ],
          extension: [
            {
              url: 'http://hl7.org/fhir/StructureDefinition/questionnaire-itemControl',
              valueCodeableConcept: {
                coding: [{ system: 'http://hl7.org/fhir/questionnaire-item-control', code: 'drop-down', display: 'Drop down' }],
                text: 'Drop down',
              },
            },
          ],
        },
        {
          ...
          type: 'date',
          code: [{ code: '11778-8', display: 'Estimated date of delivery', system: 'http://loinc.org' }],
          enableWhen: [
            {
              question: 'pregnancy-status',
              operator: '=',
              answerCoding: { system: 'http://snomed.info/sct', code: '77386006', display: 'Pregnancy' },
            },
          ],
        },
      ],
    },
    { linkId: 'languages-spoken', text: 'Languages Spoken', type: 'choice', answerValueSet: 'http://hl7.org/fhir/ValueSet/languages', repeats: true },
    { linkId: 'preferred-language', text: 'Preferred Language', type: 'choice', answerValueSet: 'http://hl7.org/fhir/ValueSet/languages' },
    {
      ...
      item: [
        ...
        { linkId: 'consent-for-treatment-date', text: 'Date', type: 'date' },
      ],
    },
    {
      ...
      item: [
        ...
        { linkId: 'agreement-to-pay-for-treatment-date', text: 'Date', type: 'date' },
      ],
    },
    {
      ...
      item: [
        ...
        { linkId: 'notice-of-privacy-practices-date', text: 'Date', type: 'date' },
      ],
    },
    {
      ...
      item: [
        ...
        { linkId: 'acknowledgement-for-advance-directives-date', text: 'Date', type: 'date' },
      ],
    },
  ],
};
